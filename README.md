...
- La photo d'un repas analysé s'affiche **annotée dans sa fiche** comme à l'évaluation : contours colorés selon la confiance, pastilles numérotées tappables (nom, glucides estimés, niveau de confiance — l'info se pose **sur la photo, du côté libre**, jamais par-dessus l'aliment sélectionné, dont le contour reste seul en pleine couleur). Pour une photo enregistrée **avant** cette fonction (donc sans géométrie), un bouton **« ✨ Annoter la photo »** fait resituer les aliments déjà connus du repas par l'IA — elle ne réévalue rien, elle pointe — et la fiche devient annotée pour de bon.
