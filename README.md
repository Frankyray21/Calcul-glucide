...
- Le total fixe est compact, avec glucides totaux et fibres dépliables.
...
La version courante est **v2.53.0**, affichée dans le pied de page de l'app (`#app-version` dans `index.html`).
